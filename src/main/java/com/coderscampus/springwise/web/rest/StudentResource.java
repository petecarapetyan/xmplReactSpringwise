...
/**
 * REST controller for managing {@link com.coderscampus.springwise.domain.Student}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Student> partialUpdateStudent(
        ...
        Optional<Student> result = studentRepository
            ...
            .map(existingStudent -> {
                ...
                if (student.getInitials() != null) {
                    existingStudent.setInitials(student.getInitials());
                }
