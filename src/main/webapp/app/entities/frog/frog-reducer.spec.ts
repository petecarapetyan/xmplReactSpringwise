...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './frog.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FROG_LIST actions', async () => {
    ...
    it('dispatches FETCH_FROG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FROG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FROG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FROG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FROG actions', async () => {
      const expectedActions = [
        {
