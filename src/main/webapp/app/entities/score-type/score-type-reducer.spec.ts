...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCORETYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCORETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCORETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCORETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCORETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCORETYPE actions', async () => {
      const expectedActions = [
        {
