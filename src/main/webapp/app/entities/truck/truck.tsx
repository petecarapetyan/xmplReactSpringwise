  ...
  return (
    <div>
      <h2 id="truck-heading" data-cy="TruckHeading">
        <Translate contentKey="xmplReactSpringwiseApp.truck.home.title">Trucks</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="xmplReactSpringwiseApp.truck.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/truck/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="xmplReactSpringwiseApp.truck.home.createLabel">Create new Truck</Translate>
          </Link>
        </div>
      </h2>
        ...
        {truckList && truckList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="xmplReactSpringwiseApp.truck.id">ID</Translate>
                </th>
                <th>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button tag={Link} to={`/truck/${truck.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="xmplReactSpringwiseApp.truck.home.notFound">No Trucks found</Translate>
            </div>
          )
        )}
      </div>
