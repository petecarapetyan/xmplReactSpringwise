...
export const TruckDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="xmplReactSpringwiseApp.truck.delete.question">
        <Translate contentKey="xmplReactSpringwiseApp.truck.delete.question" interpolate={{ id: truckEntity.id }}>
