...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dog.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOG_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOG actions', async () => {
      const expectedActions = [
        {
