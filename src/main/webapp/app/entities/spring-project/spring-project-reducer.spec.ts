...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPRINGPROJECT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SPRINGPROJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SPRINGPROJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SPRINGPROJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SPRINGPROJECT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SPRINGPROJECT actions', async () => {
      const expectedActions = [
        {
