...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './airplane.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AIRPLANE_LIST actions', async () => {
    ...
    it('dispatches FETCH_AIRPLANE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AIRPLANE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AIRPLANE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AIRPLANE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AIRPLANE actions', async () => {
      const expectedActions = [
        {
