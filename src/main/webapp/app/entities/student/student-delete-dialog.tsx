...
export const StudentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="xmplReactSpringwiseApp.student.delete.question">
        <Translate contentKey="xmplReactSpringwiseApp.student.delete.question" interpolate={{ id: studentEntity.id }}>
