...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CODINGCATEGORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_CODINGCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CODINGCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CODINGCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CODINGCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CODINGCATEGORY actions', async () => {
      const expectedActions = [
        {
