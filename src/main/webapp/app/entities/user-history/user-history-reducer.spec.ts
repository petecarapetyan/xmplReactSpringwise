...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERHISTORY actions', async () => {
      const expectedActions = [
        {
