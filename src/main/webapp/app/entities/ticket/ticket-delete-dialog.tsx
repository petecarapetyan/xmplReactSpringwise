...
export const TicketDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="xmplReactSpringwiseApp.ticket.delete.question">
        <Translate contentKey="xmplReactSpringwiseApp.ticket.delete.question" interpolate={{ id: ticketEntity.id }}>
