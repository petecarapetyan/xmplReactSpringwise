...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ticket.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TICKET_LIST actions', async () => {
    ...
    it('dispatches FETCH_TICKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TICKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TICKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TICKET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TICKET actions', async () => {
      const expectedActions = [
        {
