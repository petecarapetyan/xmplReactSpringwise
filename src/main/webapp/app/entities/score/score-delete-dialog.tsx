...
export const ScoreDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="xmplReactSpringwiseApp.score.delete.question">
        <Translate contentKey="xmplReactSpringwiseApp.score.delete.question" interpolate={{ id: scoreEntity.id }}>
