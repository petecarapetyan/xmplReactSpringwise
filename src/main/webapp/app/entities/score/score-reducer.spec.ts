...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './score.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCORE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCORE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCORE actions', async () => {
      const expectedActions = [
        {
