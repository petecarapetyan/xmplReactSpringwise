  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="xmplReactSpringwiseApp.score.home.createOrEditLabel" data-cy="ScoreCreateUpdateHeading">
            <Translate contentKey="xmplReactSpringwiseApp.score.home.createOrEditLabel">Create or edit a Score</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('xmplReactSpringwiseApp.score.points')}
                id="score-points"
                name="points"
                data-cy="points"
                type="text"
