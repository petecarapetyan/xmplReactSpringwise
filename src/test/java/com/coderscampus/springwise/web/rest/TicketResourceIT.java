...
import com.coderscampus.springwise.repository.TicketRepository;
...
class TicketResourceIT {
    ...
    public static Ticket createEntity(EntityManager em) {
        Ticket ticket = new Ticket().issue(DEFAULT_ISSUE).timeStamp(DEFAULT_TIME_STAMP);
        return ticket;
    }
    ...
    public static Ticket createUpdatedEntity(EntityManager em) {
        Ticket ticket = new Ticket().issue(UPDATED_ISSUE).timeStamp(UPDATED_TIME_STAMP);
        return ticket;
    }
    ...
    void createTicket() throws Exception {
        ...
        assertThat(testTicket.getIssue()).isEqualTo(DEFAULT_ISSUE);
        assertThat(testTicket.getTimeStamp()).isEqualTo(DEFAULT_TIME_STAMP);
    }
    ...
    void putExistingTicket() throws Exception {
        ...
        updatedTicket.issue(UPDATED_ISSUE).timeStamp(UPDATED_TIME_STAMP);
        ...
        Ticket testTicket = ticketList.get(ticketList.size() - 1);
        assertThat(testTicket.getIssue()).isEqualTo(UPDATED_ISSUE);
        assertThat(testTicket.getTimeStamp()).isEqualTo(UPDATED_TIME_STAMP);
    }
    ...
    void fullUpdateTicketWithPatch() throws Exception {
        ...
        partialUpdatedTicket.issue(UPDATED_ISSUE).timeStamp(UPDATED_TIME_STAMP);
